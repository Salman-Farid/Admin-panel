        ...
        <div class="row mt-5">
            ...
            <div class="col-md-8">
                ...
                <div class="mar-ver pad-btm text-center">
                    <h1 class="h3 text-white">{{ translate('groFresh Software Update') }} ({{ translate('Verification Bypassed') }})</h1>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('update-system')}}">
                            ...
                            <div class="form-group">
                                <label for="purchase_code" class="gap-2 mb-2">{{ translate('Codecanyon Username') }} ({{ translate('Optional') }})</label>
                                <input type="text" class="form-control" id="username" value="{{env('BUYER_USERNAME', 'admin')}}"
                                       name="username">
                            </div>

                            <div class="form-group">
                                <label for="purchase_code" class="gap-2 mb-2 mt-2">{{ translate('Purchase Code') }} ({{ translate('Optional') }})</label>
                                <input type="text" class="form-control" id="purchase_key"
                                       value="{{env('PURCHASE_CODE', 'bypassed')}}" name="purchase_key">
                            </div>
